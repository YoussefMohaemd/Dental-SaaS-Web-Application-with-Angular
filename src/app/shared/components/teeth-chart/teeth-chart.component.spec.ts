...
describe("TeethChartComponent", () => {
  ...
  it("should render 32 teeth (16 upper + 16 lower)", () => {
    const teeth = fixture.debugElement.queryAll(
      By.css('[aria-label^="Tooth "]'),
    );
  ...
  it("should emit toothToggle when a tooth is clicked", () => {
    ...
    const first = fixture.debugElement.queryAll(
      By.css('[aria-label^="Tooth "]'),
    )[0];
  ...
  it("should switch jaw filter", () => {
    ...
    const lowerLabel = fixture.debugElement
  ...
  it("should map service colors by service index (React parity)", () => {
    ...
    fixture.componentRef.setInput("serviceTeeth", {
      GFMR: [11],
      "Surgical Guide": [14],
    });
    fixture.detectChanges();
