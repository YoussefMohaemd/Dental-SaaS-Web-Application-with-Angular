...
describe('WorkflowTimelineComponent', () => {
  ...
  beforeEach(async () => {
    ...
    fixture.componentRef.setInput('stages', [
      { label: 'Received', status: 'done', owner: 'Lab', description: 'Queued', actions: [] },
      { label: 'Design', status: 'active', owner: 'Design', description: 'Working', actions: ['Review'] },
    ]);
  ...
  it('renders the timeline summary', () => {
    expect(fixture.nativeElement.textContent).toContain('1 of 2 stages complete');
  });
});