...
describe('EmptyStateComponent', () => {
  ...
  it('should display default title and description', () => {
    ...
    expect(desc.nativeElement.textContent.trim()).toBe('Try adjusting your search or filters.');
  });
  ...
  it('should display custom title and description', () => {
    ...
    expect(desc.nativeElement.textContent.trim()).toBe('Create your first order');
  });
