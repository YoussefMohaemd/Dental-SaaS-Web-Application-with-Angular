...
export class NotificationDataService {
  ...
  private static readonly FALLBACK_NOTIFICATIONS: Notification[] = [
    { id: 'n1', type: 'order', title: 'New Order Received', message: 'Order DL-024023 from Dr. Sophia Lin has been received and is awaiting review.', read: false, createdAt: '2024-12-16T10:00:00Z', relatedId: 'ord-3', relatedType: 'order' },
    { id: 'n2', type: 'workflow', title: 'Order Ready for Pickup', message: 'Order DL-024017 for Alice Johnson is now Ready and awaiting clinic collection.', read: false, createdAt: '2024-12-16T14:30:00Z', relatedId: 'ord-7', relatedType: 'order' },
  ...
  loadNotifications(): void {
    ...
    this.http.get<Notification[]>(this.API_URL).pipe(
      ...
      error: () => {
        this._notifications.set(NotificationDataService.FALLBACK_NOTIFICATIONS);
        this._loading.set(false);
      }
    });
  }
