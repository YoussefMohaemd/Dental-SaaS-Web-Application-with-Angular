...
export const PERMANENT_TEETH: DentalTooth[] = [...FDI_UPPER_NUMBERS, ...FDI_LOWER_NUMBERS].map(buildTooth);
export const UPPER_JAW_TEETH = PERMANENT_TEETH.filter(tooth => tooth.jaw === 'upper');
export const LOWER_JAW_TEETH = PERMANENT_TEETH.filter(tooth => tooth.jaw === 'lower');
