...
export class ViewOrderComponent implements OnInit {
  ...
  getStatusIconSvg(name: string): string {
  ...
  getStageSvg(name: string): string {
    const icons: Record<string, string> = {
      ...
      'more-horizontal': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>',
