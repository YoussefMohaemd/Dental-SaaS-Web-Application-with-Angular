...
export function workflowStatusFromDropListId(
  columns: readonly ColumnConfig[],
  containerId: string,
): OrderStatus | null {
  return (
    columns.find((column) => column.dropListId === containerId)?.id ?? null
  );
}
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DragDropModule, PriorityBadgeComponent, SafeHtmlPipe],
...
export class WorkflowBoardComponent {
  ...
  readonly columns: ColumnConfig[] = [
    ...
    },
    {
      ...
      dropListId: "workflow-col-review",
    },
    {
      id: "Design",
      label: "Design",
      ...
      dropListId: "workflow-col-design",
    },
    {
      id: "Production",
      label: "Production",
      ...
      dropListId: "workflow-col-production",
    },
    {
      id: "Quality Check",
      label: "QC",
      ...
      dropListId: "workflow-col-quality-check",
    },
    {
      id: "Ready",
      label: "Ready",
    ...
    },
    {
      ...
      dropListId: "workflow-col-completed",
    },
  ];
  ...
  drop(event: CdkDragDrop<Order[]>): void {
    ...
    const newStatus = workflowStatusFromDropListId(
      this.columns,
      event.container.id,
    );
  ...
  getIconSvg(name: string): string {
    const icons: Record<string, string> = {
      ...
      "alert-triangle":
        '<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',
      "refresh-ccw":
        '<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 4 1 10 7 10"></polyline><polyline points="23 20 23 14 17 14"></polyline><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4L1 10m-1.49 4.36A9 9 0 0 1 18.36 18.36"></path></svg>',
    };
    return icons[name] || "";
  }
}
