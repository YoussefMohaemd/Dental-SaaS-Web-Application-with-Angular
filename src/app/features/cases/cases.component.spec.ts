...
const MOCK_CASES: Case[] = [
  {
    id: 'case-1', caseNumber: 'CS-08101', title: 'Full Arch Restoration — Alice Johnson',
    patientId: 'pt1', patientName: 'Alice Johnson', doctorId: 'dr1', doctorName: 'Dr. Allison Park',
    clinicId: 'cl1', clinicName: 'Bright Smile Dental', status: 'Open', priority: 'High',
    ordersCount: 3, filesCount: 8, createdAt: '2024-11-10T10:00:00Z', updatedAt: '2024-12-10T14:00:00Z', notes: '',
  },
  {
    id: 'case-2', caseNumber: 'CS-08102', title: 'Smile Makeover — Benjamin Clarke',
    patientId: 'pt2', patientName: 'Benjamin Clarke', doctorId: 'dr2', doctorName: 'Dr. Marcus Webb',
    clinicId: 'cl1', clinicName: 'Bright Smile Dental', status: 'In Progress', priority: 'Normal',
    ordersCount: 2, filesCount: 5, createdAt: '2024-11-15T11:00:00Z', updatedAt: '2024-12-08T09:00:00Z', notes: '',
  },
  {
    id: 'case-3', caseNumber: 'CS-08103', title: 'Implant Case — Carmen Rodriguez',
    patientId: 'pt3', patientName: 'Carmen Rodriguez', doctorId: 'dr3', doctorName: 'Dr. Sophia Lin',
    clinicId: 'cl2', clinicName: 'Pacific Dental Group', status: 'Closed', priority: 'Low',
    ordersCount: 1, filesCount: 2, createdAt: '2024-10-20T14:00:00Z', updatedAt: '2024-12-12T15:00:00Z', notes: '',
  },
];
...
describe('CasesComponent', () => {
  ...
  it('should show the total case count', () => {
    expect(fixture.debugElement.query(By.css('h1')).nativeElement.textContent).toContain('Cases');
  ...
  it('should navigate to case details on row click', () => {
    ...
    expect(navigationService.navigate).toHaveBeenCalledWith('caseDetails', { caseId: 'case-1' });
  });
