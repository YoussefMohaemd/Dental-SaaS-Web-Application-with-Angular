...
export class ScanCenterComponent {
  ...
  readonly scanOrders = computed(() => this.orders().filter(o => o.scanCenterName));
  ...
  getIconSvg(name: string): string {
    const icons: Record<string, string> = {
      ...
      'alert-circle': '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>',
